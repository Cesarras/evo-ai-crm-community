...
module PipelineStageSerializer
  ...
  def serialize(pipeline_stage, include_item_count: false)
    result = {
      ...
      agent_bot_id: pipeline_stage.agent_bot_id,
      agent_bot_name: pipeline_stage.agent_bot&.name,
      required_label_id: pipeline_stage.required_label_id,
      required_label_title: pipeline_stage.required_label&.title,
